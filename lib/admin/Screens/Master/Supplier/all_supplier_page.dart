...
class _AllSupplierPageState extends State<AllSupplierPage> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                if ((supplier.upiScreenshot1 != null &&
                        supplier.upiScreenshot1!.isNotEmpty) ||
                    (supplier.upiScreenshot2 != null &&
                        supplier.upiScreenshot2!.isNotEmpty))
                  Container(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildDetailRow(
                        ...
                        Icons.info,
                        supplier.status == '1' ? Colors.green : Colors.red,
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildDetailRow(
    ...
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, size: 20, color: const Color(0xFF2a43a0)),
