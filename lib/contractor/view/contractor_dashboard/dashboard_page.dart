import 'package:ecoteam_app/admin/Screens/all_material_page.dart' hide AdminColors;
import 'package:ecoteam_app/admin/Screens/machinery_screen.dart';
import 'package:ecoteam_app/admin/Screens/role_management_page.dart' hide AdminColors;
                ...
                children: [
                  ...
                  if (_isMasterExpanded) ...[
                    ...
                    if (_isSupplierExpanded) ...[
                      ...
                      _buildNestedSubDrawerItem(
                        ...
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> SupplierCategoriesScreen()));
                        },
                      ),
                    ],
                    _buildExpandableSubDrawerItem(
                    ...
                    if (_isAssetsExpanded) ...[
                      ...
                      _buildNestedSubDrawerItem(
                        ...
                        onTap: () {
                          Navigator.pop(context);
                          _showSnackBar('machinery Category coming soon');
                        },
                      ),
                      _buildNestedSubDrawerItem(
                        icon: Icons.handyman,
                        ...
                        onTap: () {
                          Navigator.pop(context);
                          _showSnackBar('tools and equipment coming soon');
                        },
                      ),
                    ],
                  ],
                  ...
                  if (_isTransactionExpanded) ...[
                    _buildSubDrawerItem(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        _showSnackBar('Daily Transaction coming soon');
                      },
                    ),
                    _buildSubDrawerItem(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        _showSnackBar('Daily Consumption coming soon');
                      },
                    ),
                    _buildSubDrawerItem(
                  ...
                  if (_isProjectSitesExpanded) ...[
                    _buildSubDrawerItem(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        _showSnackBar('All Project/Site coming soon');
                      },
                    ),
                    _buildSubDrawerItem(
                  ...
                  if (_isHRMExpanded) ...[
                    ...
                    _buildSubDrawerItem(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        _showSnackBar('Attendance management coming soon');
                      },
                    ),
                    _buildSubDrawerItem(
                    ...
                    _buildSubDrawerItem(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        _showSnackBar('HR Reports coming soon');
                      },
                    ),
                  ],
                  _buildDrawerItem(
