...
class _PaymentFormBottomSheetState extends State<PaymentFormBottomSheet> {
  ...
  Future<void> _savePayment() async {
    ...
    try {
      ...
      if (widget.payment != null && widget.payment!.id != null && widget.payment!.id != 0) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            (widget.payment != null && widget.payment!.id != null && widget.payment!.id != 0) ? 'Payment updated!' : 'Payment created!',
          ),
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      (widget.payment != null && widget.payment!.id != null && widget.payment!.id != 0)
                          ? 'Edit Payment'
                          : 'Create Payment',
                      style: const TextStyle(
                        fontSize: 20,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            // Site Dropdown or Fixed Text
                            if (widget.hideSiteField && widget.fixedSiteName != null)
                              TextFormField(
                                initialValue: widget.fixedSiteName,
                                decoration: InputDecoration(
                                  labelText: 'Site',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(8),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child: _isSubmitting
                              ...
                              : Text(
                                  (widget.payment != null && widget.payment!.id != null && widget.payment!.id != 0) ? 'Update' : 'Create',
                                ),
                        ),
                      ),
                    ],
