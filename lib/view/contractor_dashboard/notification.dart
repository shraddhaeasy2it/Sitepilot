...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  final List<String> filterOptions = ['All', 'Unread', 'Documents', 'System'];
  ...
  List<Map<String, dynamic>> notifications = [
    ...
    {
      'title': 'System Update',
      'subtitle': 'The system will undergo maintenance tonight at 11 PM',
      'time': '1 day ago',
      'isRead': true,
      'type': 'system',
      'icon': Icons.settings,
    },
    {
      ...
      'subtitle': 'Project review meeting starts in 30 minutes',
      'time': 'Just now',
      'isRead': false,
      'type': 'reminder',
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Color(0xFF4a63c0).withOpacity(0.9),
                    Color(0xFF3a53b0).withOpacity(0.9),
                    Color(0xFF2a43a0).withOpacity(0.9),
                  ],
                ),
